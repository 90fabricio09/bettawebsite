...
export default function Home() {
  ...
  const portfolioItems = [
    {
      id: 1,
      title: "HB Locadora",
      description: "Identidade visual completa e desenvolvimento de website institucional para empresa de fretamento executivo",
      image: Portfolio1,
      link: "https://hblocadora.com.br",
      tags: ["Identidade Visual", "Web Design", "Branding"]
    },
    {
      id: 2,
      title: "EchoTap",
    ...
    },
    {
      id: 3,
      title: "MultiPixel",
      description: "Desenvolvimento completo de website e UI/UX design para produtora audiovisual com estúdio próprio",
      image: Portfolio3,
      link: "https://multipixel.com.br",
      tags: ["UI/UX Design", "Desenvolvimento Web", "Audiovisual"]
    },
    {
      id: 4,
      title: "Agoma.",
      description: "Desenvolvimento completo do website e UI/UX design.",
      image: Portfolio4,
  ...
  // Filtrar itens do portfólio baseado no estado
  const displayedPortfolioItems = showAllPortfolio ? portfolioItems : portfolioItems.slice(0, 3);
      ...
      <section id="portfolio" className="portfolio">
        ...
        <div className="portfolio-grid">
          {displayedPortfolioItems.map((item) => (
            <a key={item.id} href={item.link} target="_blank" rel="noopener noreferrer" className="portfolio-item">
              <div className="portfolio-image" style={{ backgroundImage: `url(${item.image})` }} role="img" aria-label={`Projeto ${item.title}`}></div>
          ...
          <div className="portfolio-button-container">
            ...
            >
              {showAllPortfolio ? (
                ...
                <>
                  Ver mais <i className="bi bi-chevron-down"></i>
                </>
              )}
            </button>
          </div>
